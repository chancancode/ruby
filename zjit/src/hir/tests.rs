...
mod snapshot_tests {
    ...
    fn test_send_direct_with_reordered_kwargs_has_snapshot() {
        ...
        bb2(v6:BasicObject):
          ...
          v26:BasicObject = SendDirect v24, 0x1048, :foo (0x1050), v13, v15, v11
          v18:Any = Snapshot FrameState { pc: 0x1058, stack: [v26], locals: [] }
          PatchPoint NoTracePoint
          CheckInterrupts
          Return v26
        ");
    ...
    fn test_send_direct_with_kwargs_in_order_has_snapshot() {
        ...
        bb2(v6:BasicObject):
          ...
          v23:BasicObject = SendDirect v22, 0x1048, :foo (0x1050), v11, v13
          v16:Any = Snapshot FrameState { pc: 0x1058, stack: [v23], locals: [] }
          PatchPoint NoTracePoint
          CheckInterrupts
          Return v23
        ");
